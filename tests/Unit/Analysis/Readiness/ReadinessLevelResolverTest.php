...
it('resolves laravel adapter for laravel-adapter tag', function () {
...
it('resolves legacy for legacy-code tag', function () {
...
it('resolves multitag when multiple tags are present', function () {
    $result = new AnalysisResult(collect([
