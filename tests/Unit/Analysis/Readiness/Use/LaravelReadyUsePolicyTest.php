...
it('denies multiple wf imports', function () {
    $result = new AnalysisResult(collect([
        new UseImportFinding('Wf\Legacy\OldRepo', 5),
...
it('allows laravel-ready app import', function () {
    $result = new AnalysisResult(collect([
...
it('allows tagged laravel-ready app import', function () {
    $result = new AnalysisResult(collect([
...
it('allows another laravel-ready app import', function () {
    $result = new AnalysisResult(collect([
...
it('denies app import with class php extension only', function () {
    $result = new AnalysisResult(collect([
